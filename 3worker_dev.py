...
a = "ffmpeg -ss "
b = " -i "
c = " -movflags use_metadata_tags -c:v libsvtav1 -b:v 2.25M -preset 6 -an -t "
d = " "
...
fileFragExt = [Out1, Out2] # this one baru filename + frag Array
...
af.write("ffmpeg -i "+ videoPath +" -movflags use_metadata_tags -vn -c:a copy " + aacPath)
af.close()
...
af.write("ffmpeg -f concat -safe 0 -y -i concatList.txt -i "+ aacPath +" -movflags use_metadata_tags -c copy " + outConcatPlusAudio)
af.close()
